...
export default function Popup(props: PopupProps) {
  const { popupDisplay, setPopupDisplay } = useContext(
    PopupContext,
  ) as PopupContextType;
  let title;
  let content;
        ...
        <>
          <div className={styles.innerContainer}>
            <Button
              style="option"
              title="Create group"
              onClick={() => setPopupDisplay("addGroup")}
            />
            <Button
              style="option"
              title="Start direct chat"
              onClick={() => setPopupDisplay("addDirect")}
            />
          </div>
          <Button
            style="grey"
      ...
      content = (
        <>
          <form
            onSubmit={(e: any) => {
              e.preventDefault();
              handleAddGroup(e.target.name.value);
      ...
      content = (
        <>
          <form
            onSubmit={(e: any) => {
              e.preventDefault();
              handleAddDirect(e.target.email.value);
              setPopupDisplay("none");
            }}
          >
            <div className={styles.innerContainer}>
      ...
      content = (
        <>
          <form
            onSubmit={(e: any) => {
              e.preventDefault();
              handleInvite(e.target.email.value, props.chatId!);
              setPopupDisplay("none");
            }}
          >
            <div className={styles.innerContainer}>
      ...
      content = (
        <>
          <form
            onSubmit={(e: any) => {
              e.preventDefault();
              handleChangeName(e.target.name.value);
              setPopupDisplay("none");
            }}
          >
            <div className={styles.innerContainer}>
            ...
            <div className={styles.buttonContainer}>
              <Button
                style="grey"
                onClick={() => setPopupDisplay("settings")}
                title="Cancel"
              />
        ...
        <>
          <div className={styles.innerContainer}>
            <Button
              style="option"
              title="Change username"
              onClick={() => setPopupDisplay("changeName")}
            />
            <Button
              style="option"
              title="Change password"
              onClick={() => setPopupDisplay("changePassword")}
            />
