...
describe("Button - rendering", () => {
    ...
    it("Should render button styles correctly", ()=> {
        ...
        expect(screen.getByRole("button", { name: "Click me" })).toHaveClass("negative");
    });
    ...
    it("Should render a button icon", ()=> {
        ...
        expect(screen.getByRole("button", { name: "First" }).querySelector("svg")).toBeInTheDocument();
        expect(screen.getByRole("button", { name: "Second" }).querySelector("svg")).not.toBeInTheDocument();
    });
});
...
describe("Button - click", () => {
    ...
    it("Should submit a form on click", () => {
        const mockCallback = jest.fn();
        render(<form onSubmit={(e: any) => {e.preventDefault(); mockCallback(true)}}>
